...
CREATE TABLE `reservation` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKbxmxk7wn5xd1kokfxanr1jkkh` (`order_id`),
  KEY `FKgoouhtuwwm277879njd9atahw` (`product_id`),
  CONSTRAINT `FKbxmxk7wn5xd1kokfxanr1jkkh` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`),
...
INSERT INTO `reservation` VALUES (29,25,60,9),(30,30,61,10),(31,22,62,11);
